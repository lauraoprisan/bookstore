...
function App() {
  ...
  const fetchItems = () => {
    fetch('https://bookstore-f2ed5-default-rtdb.europe-west1.firebasedatabase.app/books/.json')
  ...
  const deleteBook = (id) => {
    fetch(`https://bookstore-f2ed5-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
    {
      method: 'DELETE',
    })
    .then(response => fetchItems())
  ...
  return (
    <div className="App"> 
      ...
      <div className="ag-theme-material" style={ { height: 400, width: 1090, margin: 'auto' } }>
